   ...
   (
      ...
      return (
         <SliderPrimitive.Root
            ref={ref}
            className={cn(
               'relative flex w-1/4 touch-none select-none items-center',
               className
            )}
            {...props}
         >
            <SliderPrimitive.Track className="relative h-3 w-full grow overflow-hidden rounded-full dark:bg-gray-800 bg-gray-300">
